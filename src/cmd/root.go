...
import (
	...
	"github.com/wily13/go-whatsapp-api/controllers"
	"github.com/wily13/go-whatsapp-api/middleware"
...
var rootCmd = &cobra.Command{
	...
	Long: `This application is from clone https://github.com/wily13/go-whatsapp-api, 
...
func runRest(cmd *cobra.Command, args []string) {
	...
	err = app.Listen(config.AppIP + ":" + config.AppPort)
	if err != nil {
